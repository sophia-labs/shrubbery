/**
 * Shell-owned Cognito authentication for the hosted Organism deployment.
 *
 * The component package only emits auth intents. This module performs the real
 * Cognito Identity Provider calls, persists/refreshes tokens, and exposes the
 * narrow AuthProvider shape consumed by a ShrubberyContract.
 */
